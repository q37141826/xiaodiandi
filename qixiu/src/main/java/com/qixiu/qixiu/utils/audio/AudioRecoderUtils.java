...
public class AudioRecoderUtils {
  ...
  /* ①Initial：实例化MediaRecorder对象 */
   ...
   /* 获取开始时间* */
    ...
    public PopupWindow setDefaultView(Context context,View touchView) {
        contentView = View.inflate(context, R.layout.pop_audio_record, null);
        imageView = contentView.findViewById(R.id.imageView_audio_record);
