...
package com.qixiu.qixiu.google.zxing.client.android.share;
...
/**
 * Barcode Scanner can activity_zxing_share data like contacts and bookmarks by displaying a QR Code on screen,
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent intent) {
    if (resultCode == RESULT_OK) {
      switch (requestCode) {
        case PICK_BOOKMARK:
       /* case PICK_APP:
          showTextAsBarcode(intent.getStringExtra(Browser.BOOKMARKS_URI.URL));
          break;*/
        case PICK_CONTACT:
