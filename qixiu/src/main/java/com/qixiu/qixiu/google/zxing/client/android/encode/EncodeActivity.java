...
import com.qixiu.qixiu.google.zxing.client.android.FinishListener;
...
public final class EncodeActivity extends Activity {
  ...
  public void onCreate(Bundle icicle) {
    ...
    if (intent == null) {
      ...
      if (Intents.Encode.ACTION.equals(action) || Intent.ACTION_SEND.equals(action)) {
        setContentView(R.layout.activity_zxing_encode);
      } else {
        finish();
      }
    }
  ...
  protected void onResume() {
    ...
    try {
      ...
      if (bitmap == null) {
        Log.w(TAG, "Could not activity_zxing_encode barcode");
      ...
      Log.w(TAG, "Could not activity_zxing_encode barcode", e);
      showErrorMessage(R.string.msg_encode_contents_failed);
      qrCodeEncoder = null;
    }
  }
