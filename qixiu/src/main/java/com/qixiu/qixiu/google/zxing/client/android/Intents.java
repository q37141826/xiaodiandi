...
public final class Intents {
  ...
  public static final class Encode {
    /**
     * Send this intent to activity_zxing_encode a piece of data as a QR code and display it full screen, so
     * that another person can scan the barcode from your screen.
     */
    public static final String ACTION = "com.google.zxing.client.android.ENCODE";

    /**
     * The data to activity_zxing_encode. Use {@link android.content.Intent#putExtra(String, String)} or
     ...
     * boolean to false will hide that TextView, showing only the activity_zxing_encode barcode.
     */
  ...
  public static final class Share {
    /**
     * Give the user a choice of items to activity_zxing_encode as a barcode, then render it as a QR Code and
