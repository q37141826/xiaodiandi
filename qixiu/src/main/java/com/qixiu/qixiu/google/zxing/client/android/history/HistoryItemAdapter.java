...
package com.qixiu.qixiu.google.zxing.client.android.history;
...
final class HistoryItemAdapter extends ArrayAdapter<HistoryItem> {
  ...
  HistoryItemAdapter(Activity activity) {
    super(activity, R.layout.item_zxing_history, new ArrayList<HistoryItem>());
  ...
  public View getView(int position, View view, ViewGroup viewGroup) {
    ...
    if (view instanceof LinearLayout) {
      ...
      layout = (LinearLayout) factory.inflate(R.layout.item_zxing_history, viewGroup, false);
    }
